...
filename1 = "dataset_lkv_09012023.tsv" #Older Data Set
filename2 = "dataset_lkv_01022023.tsv" #Newer Data Set

cwd = os.getcwd()

file1 = cwd + "\\DATA_SETS\\CLEAN\\" + filename1
file2 = cwd + "\\DATA_SETS\\CLEAN\\" + filename2
fileO = cwd + "\\DATA_SETS\\CLEAN\\COMPARATIVE_DATA\\" +"ConcatTotalItemSavings_%s.csv" %(filename1[:-4]+filename2[:-4],)
    ...
    #for row1 in reader1:
        ...
        for row2 in reader2:
            ...
            if row1[0] == row2[0]:
                ...
                if INIT_CHKOUT == 0.0 and SECD_CHKOUT >= 1.0:
                    SAVED = (TOT_CHKOUT - 1) * PRICE #saved
                elif INIT_CHKOUT == 0.0 and SECD_CHKOUT == 0.0:
                    SAVED = (-1 * PRICE)
                else:
        ...
        for row1 in reader1:
            ...
            if row2[0] != row1[0]:
                ...
                if counter == num_rows1:
                    ...
                    SAVED = (TOT_CHKOUT - 1) * PRICE
                    # Perform operations on the unmatched row
                    new_row = BARCODE + " | " + "new" + " | " + str(SECD_CHKOUT) + " | " + str(TOT_CHKOUT) + " | " + str(PRICE) + " | " + str(SAVED)
